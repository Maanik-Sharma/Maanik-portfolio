...
import { AnimatedTestimonialsCard } from "./components/AnimatedTestimonialsCard";
...
function Homepage() {
        ...
        <div className="dark:bg-[#1E1E1E] bg-white border dark:border-neutral-600 border-neutral-400/60 shadow-xl relative rounded-lg sm:h-40  ">
          <div className=" absolute w-full p-2">
            ...
            <div className="">
              ...
              <a href="mailto:maanik.sharma.work@gmail.com">
        ...
        >
          ...
          <motion.img
            ...
            // src={theme == "dark" ? "/lightm.bmp" : "/map.jpg"}
                src={theme == "dark" ? "/NewLinkedInPfp.jpg" : "/NewLinkedInPfp.jpg"}
            alt=""
          />
        </motion.div>
  ...
  >
    ...
    <ArrowOutwardIcon fontSize="small" />
            ...
            <div className="w-full h-[0.9px] dark:bg-neutral-600 bg-neutral-400/60 mt-1 top-10  " />
            <ProjectsCarousel/>
            {/* <CVCard pdfUrl="/CV English.pdf" /> */}
          </div>
          ...
          <div className="mt-14 mb-4">
            <div className="flex justify-center gap-x-2 px-2">
              <Tooltip showArrow={true} content="X (Twitter)" color="#161616">
                <Link
                  href={"https://twitter.com/yi_Decipher"}
              ...
              <Tooltip showArrow={true} content="GitHub" color="#161616">
                <Link
                  href={"https://github.com/Maanik-Sharma"}
                  className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                >
              ...
              <Tooltip showArrow={true} content="Linkedin" color="#161616">
                <Link
                  href={"https://www.linkedin.com/in/maaniksharma/"}
                  className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                >
              ...
              <Tooltip showArrow={true} content="E-mail" color="#161616">
                <Link
                  href={"0maanik.sharma.work@gmail.com"}
                  className="rounded-full border dark:border-neutral-600 cursor-pointer border-neutral-400/60 p-2 w-16 h-16 flex items-center justify-center"
                >
